/*! fullproof v20120919 | https://github.com/reyesr/fullproof/blob/master/LICENSE */
var fullproof=fullproof||{};
(function(){function a(a){for(var d=[],c=0;c<a.length;++c)a[c].constructor==Array?d=d.concat(a[c]):d.push(a[c]);return d}fullproof.AbstractAnalyzer=function(){this.getArray=function(a,d){var c=fullproof.make_synchro_point(function(a){d(a)});this.parse(a,c)}};fullproof.StandardAnalyzer=function(){var b=a(arguments);if(!(this instanceof fullproof.StandardAnalyzer))return new fullproof.StandardAnalyzer(b);this.provideScore=!1;this.sendFalseWhenComplete=!0;this.parse=function(a,c){var i=this,g=function(a){if("string"==
typeof a){a=a.trim();if(""!=a)for(var d=0;d<b.length;++d)a=b[d](a);c&&(a&&""!=a)&&c(a)}else!1===a&&(i.sendFalseWhenComplete&&c)&&c(a)},f;f=net.kornr.unicode.is_letter_number;for(var e="",h=0,j=a.length;h<j;++h)f(a.charCodeAt(h))?e+=a[h]:0<e.length&&(g(e),e="");0<e.length&&g(e);g(!1)}};fullproof.StandardAnalyzer.prototype=new fullproof.AbstractAnalyzer;fullproof.ScoringAnalyzer=function(){var b=a(arguments),d=new fullproof.StandardAnalyzer(b);this.provideScore=this.sendFalseWhenComplete=d.sendFalseWhenComplete=
!0;this.parse=function(a,b){var g={},f=0,e=0,h=this;d.parse(a,function(a){if(!1!==a){if(void 0===g[a]||g[a].constructor!==Array)g[a]=[];g[a].push(f);e+=++f}else{for(var d in g){for(var c=g[d],o=a=0;o<c.length;++o)a+=(3.1415-Math.log(1+c[o]))/10;c=Math.abs(Math.log(1+c.length))/10;b(new fullproof.ScoredEntry(d,void 0,1+1.5*a+3*c))}!0==h.sendFalseWhenComplete&&b(!1)}})}};fullproof.ScoringAnalyzer.prototype=new fullproof.AbstractAnalyzer})();fullproof=fullproof||{};
fullproof.BooleanEngine=function(a){function b(a,c,i,g,f){if(0==g.length)return i(!1);var e=g.shift();++a.lastResultIndex;e.analyzer.parse(c,fullproof.make_synchro_point(function(h){if(!h||0==h.length)return 0<g.length?b(a,c,i,g,f):i(!1);for(var j=fullproof.make_synchro_point(function(e){for(var j=e.shift();0<e.length;){var l=e.shift();switch(f){case fullproof.BooleanEngine.CONST_MODE_UNION:j.merge(l);break;default:j.intersect(l)}}if(0==j.getSize()){if(0<g.length)return b(a,c,i,g,f);i(!1)}else i(j)},
h.length),l=0;l<h.length;++l)e.index.lookup(h[l],j)}))}if(!(this instanceof fullproof.BooleanEngine))return new fullproof.BooleanEngine(a);this.initAbstractEngine(a);this.booleanMode=fullproof.BooleanEngine.CONST_MODE_INTERSECT;this.lookup=function(a,c){this.lastResultIndex=0;b(this,a,c,this.getIndexUnits(),this.booleanMode);return this}};fullproof.AbstractEngine=fullproof.AbstractEngine||function(){};fullproof.BooleanEngine.prototype=new fullproof.AbstractEngine;
...
fullproof.Capabilities.prototype.setScoreModifier=function(a){this.scoreModifier=a;return this};fullproof.Capabilities.prototype.getScoreModifier=function(){return this.scoreModifier};fullproof.Capabilities.prototype.isCompatibleWith=function(a){var b=this.matchValue(this.canStoreObjects,a.canStoreObjects),d=this.matchValue(this.isVolatile,a.isVolatile),a=this.matchValue(this.useScores,a.useScores),c=!0===this.isAvailable;return b&&d&&c&&a};fullproof=fullproof||{};
fullproof.TextInjector=function(a,b){if(!(this instanceof fullproof.TextInjector))return new fullproof.TextInjector(a,b);this.index=a;this.analyzer=b};fullproof.TextInjector.prototype.inject=function(a,b,d){var c=this;this.analyzer.getArray(a,function(a){for(var g=fullproof.make_synchro_point(d,a.length),f=0;f<a.length;++f){var e=a[f];e instanceof fullproof.ScoredEntry?(e.value=void 0===e.value?b:e.value,c.index.inject(e.key,e,g)):c.index.inject(a[f],b,g)}})};
fullproof.TextInjector.prototype.injectBulk=function(a,b,d,c){for(var i=[],g=[],f=this,e=0,h=Math.min(a.length,b.length);e<h;++e)(function(a,c){f.analyzer.getArray(a,function(a){for(var d=0;d<a.length;++d){var b=a[d];b instanceof fullproof.ScoredEntry?(b.value=void 0===b.value?c:b.value,i.push(b.key),g.push(b)):(i.push(b),g.push(c))}})})(a[e],b[e]);this.index.injectBulk(i,g,d,c)};
fullproof.IndexUnit=function(a,b,d,c,i){this.name=a;this.capabilities=b;this.analyzer=d;this.initializer=c;this.index=i};fullproof.AbstractEngine=fullproof.AbstractEngine||function(){};fullproof.AbstractEngine.prototype.checkCapabilities=function(){return!0};fullproof.AbstractEngine.addIndexes=function(a,b,d){for(var c=!1;0<b.length;)var i=b.pop(),c=function(c,b){return function(){fullproof.AbstractEngine.addIndex(a,b.name,b.analyzer,b.capabilities,b.initializer,!1!==c?c:d)}}(c,i);!1!==c&&c();return this};
fullproof.AbstractEngine.addIndex=function(a,b,d,c,i,g){var f=new fullproof.IndexUnit(b,c,d);if(!a.checkCapabilities(c,d))return g(!1);d=new fullproof.IndexRequest(b,c,function(a,c){var d=new fullproof.TextInjector(a,f.analyzer);i(d,c)});if(a.storeManager.addIndex(d))return void 0===a.indexes&&(a.indexes=[]),a.indexes.push(f),a.indexesByName[b]=f,g&&g(!0),!0;g&&g(!1);return!1};
fullproof.AbstractEngine.prototype.open=function(a,b,d){var c=this,a=a.constructor!==Array?[a]:a;fullproof.AbstractEngine.addIndexes(c,a);this.storeManager.openIndexes(function(){c.storeManager.forEach(function(a,d){c.indexesByName[a].index=d});b(c)},d);return this};fullproof.AbstractEngine.prototype.injectDocument=function(a,b,d){var c=fullproof.make_synchro_point(function(){d()});this.forEach(function(d,g,f){d&&f.parse(a,function(a){a?g.inject(a,b,c):c(!1)})},!1);return this};
fullproof.AbstractEngine.prototype.clear=function(a){if(0===this.getIndexCount())return a();var b=fullproof.make_synchro_point(a,this.getIndexCount());this.forEach(function(a,c){a?c.clear(b):b(!1)})};fullproof.AbstractEngine.prototype.initAbstractEngine=function(a){this.storeManager=new fullproof.StoreManager(a);this.indexes=[];this.indexesByName={};return this};fullproof.AbstractEngine.prototype.getIndex=function(a){return this.indexesByName[a].index};
fullproof.AbstractEngine.prototype.getIndexUnits=function(){return[].concat(this.indexes)};fullproof.AbstractEngine.prototype.forEach=function(a){for(var b=0,d=this.indexes.length;b<d;++b)a(this.indexes[b].name,this.indexes[b].index,this.indexes[b].analyzer);for(b=1;b<arguments.length;++b)a(arguments[b]);return this};fullproof.AbstractEngine.prototype.getIndexCount=function(){return this.indexes.length};fullproof=fullproof||{};fullproof.normalizer=fullproof.normalizer||{};
fullproof.normalizer.to_lowercase_decomp=function(a,b){a=a?net.kornr.unicode.lowercase(a):a;return b?b(a):a};fullproof.normalizer.to_lowercase_nomark=function(a,b){a=a?net.kornr.unicode.lowercase_nomark(a):a;return b?b(a):a};fullproof.normalizer.remove_duplicate_letters=function(a,b){var d=a?"":!1,c=!1;if(a){for(var i=0,g=a.length;i<g;++i)c&&c!=a[i]&&(d+=c),c=a[i];d+=c?c:""}return b?b(d):d};fullproof.normalizer.filter_in_object=function(a,b,d){return b[a]?d?d(!1):!1:d?d(a):a};
fullproof=fullproof||{};
(function(){function a(a){return a}var b={lower_than:function(a,c){return a<c},equals:function(a,c){return a==c}};fullproof.binary_search=function(a,c,i,g,f){f=f||b.lower_than;if(void 0===i&&void 0===g)return 0==a.length?0:fullproof.binary_search(a,c,0,a.length,f);for(;g>=i;){var e=parseInt((g+i)/2);if(e>=a.length)return a.length;if(f(a[e],c))i=e+1;else if(f(c,a[e]))g=e-1;else return e}return i};fullproof.ResultSet=function(a,c){if(!(this instanceof fullproof.ResultSet))return new fullproof.ResultSet(a,c);
this.comparatorObject=a||b;this.data=c||[];this.last_insert=void 0};fullproof.ResultSet.prototype.insert=function(){for(var a=0;a<arguments.length;++a){var c=arguments[a];if(this.last_insert&&this.comparatorObject.lower_than(this.last_insert,c))this.data.push(c),this.last_insert=c;else{var b=fullproof.binary_search(this.data,c,void 0,void 0,this.comparatorObject.lower_than);b>=this.data.length?(this.data.push(c),this.last_insert=c):!1==this.comparatorObject.equals(c,this.data[b])&&(this.data.splice(b,
0,arguments[a]),this.last_insert=void 0)}}return this};fullproof.ResultSet.prototype.merge=function(d,c){c=c||a;this.last_insert=void 0;var b=!1;d.constructor==Array?b=d:d instanceof fullproof.ResultSet&&(b=d.getDataUnsafe());for(var g=0,f=this.data.length,e=0,h=b.length,j=null,l=null,q=this.comparatorObject,o=[];g<f&&e<h;)j=this.data[g],l=b[e],q.equals(j,l)?(o.push(c(j,l)),++g,++e):q.lower_than(j,l)?(o.push(j),++g):(o.push(l),++e);for(;g<f;)o.push(this.data[g]),++g;for(;e<h;)o.push(b[e]),++e;this.data=
o;return this};fullproof.ResultSet.prototype.intersect=function(a){this.last_insert=void 0;var c=!1;a.constructor==Array?c=a:a instanceof fullproof.ResultSet&&(c=a.getDataUnsafe());if(c){for(var a=[],b=0,g=0,f=this.data.length,e=c.length;b<f;){for(;g<e&&this.comparatorObject.lower_than(c[g],this.data[b]);)++g;g<e&&this.comparatorObject.equals(c[g],this.data[b])?(a.push(c[g]),++b,++g):b++}this.data=a}else this.data=[];return this};fullproof.ResultSet.prototype.substract=function(a){this.last_insert=
void 0;var c=!1;a.constructor==Array?c=a:a instanceof fullproof.ResultSet&&(c=a.getDataUnsafe());if(c){for(var a=[],b=0,g=0,f=this.data.length,e=c.length;b<f;){for(;g<e&&this.comparatorObject.lower_than(c[g],this.data[b]);)++g;g<e&&this.comparatorObject.equals(c[g],this.data[b])?(++b,++g):(a.push(this.data[b]),b++)}this.data=a}else this.data=[];return this};fullproof.ResultSet.prototype.getItem=function(a){return this.data[a]};fullproof.ResultSet.prototype.getDataUnsafe=function(){return this.data};
fullproof.ResultSet.prototype.setDataUnsafe=function(a){this.last_insert=void 0;this.data=a;return this};fullproof.ResultSet.prototype.setComparatorObject=function(a){this.comparatorObject=a;var c=this;this.data.sort(function(a,b){return c.comparatorObject.lower_than(a,b)?-1:c.comparatorObject.equals(a,b)?0:1})};fullproof.ResultSet.prototype.toString=function(){return this.data.join(",")};fullproof.ResultSet.prototype.forEach=function(a){for(var c=0,b=this.data.length;c<b;++c)a(this.data[c]);return this};
...
fullproof.ScoringEngine.prototype.checkCapabilities=function(a,b){if(!0!==a.getUseScores())throw"capabilities.getUseScore() must be true";if(!0!==b.provideScore)throw"analyzer.provideScore must be true";if(!a.getComparatorObject())throw"capabilities.getComparatorObject() must return a valid comparator";return!0};
fullproof.ScoringEngine.prototype.lookup=function(a,b){function d(a,c){if(0==a.length)return new fullproof.ResultSet(c.capabilities.getComparatorObject());for(var b=a.shift();0<a.length;)b.merge(a.shift(),fullproof.ScoredElement.mergeFn);return b}for(var c=this.getIndexUnits(),i=fullproof.make_synchro_point(function(a){a=d(a);b(a)},c.length),g=0;g<c.length;++g){var f=c[g];f.analyzer.parse(a,fullproof.make_synchro_point(function(a){if(a)if(0==a.length)b(new fullproof.ResultSet(store.caps.getComparatorObject()));
else for(var c=fullproof.make_synchro_point(function(a){a=d(a,f);if(void 0!==f.capabilities.getScoreModifier())for(var c=f.capabilities.getScoreModifier(),b=0,g=a.getDataUnsafe(),e=g.length;b<e;++b)g[b].score*=c;i(a)},a.length),g=0;g<a.length;++g)f.index.lookup(a[g].key,c)}))}};fullproof=fullproof||{};fullproof.StoreDescriptor=function(a,b){if(!(this instanceof fullproof.StoreDescriptor))return new fullproof.StoreDescriptor(a,b);this.name=a;this.ref=b};
...
a:{c=a.capabilities;var b=[].concat(this.available);if(!(b.constructor!=Array||0==b.length))for(var g=0;g<b.length;++g)if(b[g].ref.getCapabilities().isCompatibleWith(c)){c=b[g];break a}c=!1}this.indexes[a.name]={req:a,storeRef:c};c&&(void 0===this.indexesByStore[c.name]&&(this.indexesByStore[c.name]=[],this.indexesByStore[c.name].ref=c.ref,++this.storeCount),this.indexesByStore[c.name].push(a.name));return!!c};this.openIndexes=function(a,c){if(0===this.storeCount)return a();var c=c||function(){},
b=fullproof.make_synchro_point(a,this.storeCount),g;for(g in this.indexesByStore){for(var f=new this.indexesByStore[g].ref,e=this.indexesByStore[g],h=[],j=new fullproof.Capabilities,l=0,q=0;q<e.length;++q){var o=this.indexes[e[q]];h.push(o.req);o.req.capabilities&&o.req.capabilities.getDbSize()&&(l+=Math.max(o.req.capabilities.getDbSize(),0));o.req.capabilities&&o.req.capabilities.getDbName()&&j.setDbName(o.req.capabilities.getDbName())}0!=l&&j.setDbSize(l);var u=this;f.open(j,h,function(a){if(a&&
0<a.length){for(var d=0;d<a.length;++d){var e=a[d];e.parentStore=f;e.storeName=g;u.indexes[e.name].index=e}b(f)}else c()},c)}};this.getInfoFor=function(a){return this.indexes[a]};this.getIndex=function(a){return this.indexes[a].index};this.forEach=function(a){for(var c in this.indexes)a(c,this.indexes[c].index)}};fullproof=fullproof||{};fullproof.ScoredElement=function(a,b){if(!(this instanceof fullproof.ScoredElement))return new fullproof.ScoredElement(a,b);this.value=a;this.score=void 0===b?1:b};
...
fullproof.ScoredElement.mergeFn=function(a,b){return new fullproof.ScoredElement(a.value,a.score+b.score)};fullproof.ScoredEntry=function(a,b,d){if(!(this instanceof fullproof.ScoredEntry))return new fullproof.ScoredEntry(a,b,d);this.key=a;this.value=b;this.score=void 0===d?1:d};fullproof.ScoredEntry.prototype=new fullproof.ScoredElement;fullproof.ScoredEntry.comparatorObject=fullproof.ScoredElement.comparatorObject;fullproof.ScoredEntry.prototype.getKey=function(){return this.key};
fullproof.ScoredEntry.prototype.toString=function(){return"["+this.key+"="+this.value+"|"+this.score+"]"};fullproof.make_synchro_point=function(a,b,d,c){var i=0,g=[];return function(f){if(void 0!==c&&!1===f)throw c;!1===b||void 0===b?!1===f?a(g):g.push(f):(++i,g.push(f),d&&(console&&console.log)&&console.log("synchro point "+("string"==typeof d?d+": ":": ")+i+" / "+b),i==b&&a(g))}};
fullproof.call_new_thread=function(){var a=Array.prototype.slice.call(arguments);setTimeout(function(){0<a.length&&a.shift().apply(this,a)},1)};fullproof.make_callback=function(a){var b=Array.prototype.slice.call(arguments,1);return function(){a&&a.apply(this,b)}};fullproof.thrower=function(a){return function(){throw a;}};fullproof.bind_func=function(a,b){return function(){var d=Array.prototype.slice.apply(arguments);return b.apply(a,d)}};
fullproof.filterObjectProperties=function(a,b){a instanceof fullproof.ResultSet&&(a=a.getDataUnsafe());for(var d=[],c=0,i=a.length;c<i;++c)d.push(a[c][b]);return d};fullproof.IndexRequest=function(a,b,d){if(!(this instanceof fullproof.IndexRequest))return new fullproof.IndexRequest(a,b,d);this.name=a;this.capabilities=b;this.initializer=d};fullproof.isFunction=function(a){return"function"==typeof a||a instanceof Function};fullproof.HMap=function(){};
fullproof.HMap.prototype.put=function(a,b){this["$"+a]=b};fullproof.HMap.prototype.putInArray=function(a,b){var d="$"+a;if(!this[d]||this[d].constructor!==Array)this[d]=[];this[d].push(b)};fullproof.HMap.prototype.get=function(a){return this["$"+a]};fullproof.HMap.prototype.forEach=function(a){for(var b in this)"$"===b[0]&&a(b.substring(1))};fullproof=fullproof||{};fullproof.store=fullproof.store||{};
(function(a){function b(a,c,b){a.onsuccess=c;a.onerror=b;return a}function d(a,c,d,g){a=a.put(c);b(a,fullproof.make_callback(d,c),g)}function c(a,c,b,g,e){function f(){fullproof.isFunction(b)&&(b=b());d(a,b,g,e)}try{var h=a.get(c)}catch(i){console&&console.log&&console.log(i)}h.onsuccess=function(a){void 0===a.target.result?void 0!==b?f():e():g(h.result)};h.onerror=f}function i(a,c,b,d,g){this.parent=a;this.database=c;this.name=b;this.comparatorObject=d;this.internalComparator=(this.useScore=g)?function(a,
c){return this.comparatorObject(a.value,c.value)}:function(a,c){return this.comparatorObject(a,c)}}function g(a,b,e,f,h,i,k){if(0<e.length&&i<k){var m=e[i],n=f.get(m);c(b,m,function(){return{key:m,v:[]}},function(c){var m=(new fullproof.ResultSet(a.comparatorObject)).setDataUnsafe(c.v);m.merge(n);c.v=m.getDataUnsafe();d(b,c,function(){g(a,b,e,f,h,i+1,k)},function(){h(!1)})})}else h(!0)}function f(a,c,b){a.objectStoreNames.contains(b)||a.createObjectStore(b,{keyPath:"id"});for(b=0;b<c.length;++b)a.objectStoreNames.contains(c[b].name)||
a.createObjectStore(c[b].name,{keyPath:"key"})}try{fullproof.store.indexedDB=a.indexedDB||a.webkitIndexedDB||a.mozIndexedDB||a.msIndexedDB,fullproof.store.IDBTransaction=a.IDBTransaction||a.webkitIDBTransaction||a.mozIDBTransaction||a.msIDBTransaction||{},fullproof.store.READWRITEMODE=fullproof.store.IDBTransaction.readwrite||fullproof.store.IDBTransaction.READ_WRITE||"readwrite"}catch(e){fullproof.store.indexedDB=a.indexedDB,fullproof.store.IDBTransaction=a.IDBTransaction,fullproof.store.READWRITEMODE=
"readwrite"}i.prototype.clear=function(a){var a=a||function(){},c=this,d=fullproof.make_callback(a,!1),g=this.database.transaction([this.name,this.parent.metaStoreName],fullproof.store.READWRITEMODE).objectStore(this.parent.metaStoreName);b(g.put({id:this.name,init:!1}),function(){fullproof.call_new_thread(function(){var g=c.database.transaction([c.name],fullproof.store.READWRITEMODE).objectStore(c.name).clear();b(g,fullproof.make_callback(a,!0),d)})},d)};i.prototype.inject=function(a,b,g){var e=
this.database.transaction([this.name],fullproof.store.READWRITEMODE).objectStore(this.name),f=this;c(e,a,function(){return{key:a,v:[]}},function(a){var c=(new fullproof.ResultSet(f.comparatorObject)).setDataUnsafe(a.v);b instanceof fullproof.ScoredElement?f.useScore?c.insert({v:b.value,s:b.score}):c.insert(b.value):c.insert(b);a.v=c.getDataUnsafe();d(e,a,g,fullproof.make_callback(g,!1))},fullproof.make_callback(g,!1))};var h={lower_than:function(a,c){return(a.v?a.v:a)<(c.v?c.v:c)},equals:function(a,
c){return(a.v?a.v:a)===(c.v?c.v:c)}};i.prototype.injectBulk=function(a,c,b,d){function e(a,c,b,d,h,i){h&&h(i/c.length);var j=a.database.transaction([a.name],fullproof.store.READWRITEMODE).objectStore(a.name);g(a,j,c,b,function(g){i<c.length?fullproof.call_new_thread(e,a,c,b,d,h,i+f):d(g)},i,Math.min(i+f,c.length))}if(a.length!==c.length)throw"Can't injectBulk, arrays length mismatch";for(var f=100,i=[],m=0,n=a.length,r=new fullproof.HMap;m<n;++m){var s=a[m],t=c[m];void 0===r.get(s)&&(r.put(s,new fullproof.ResultSet(h)),
i.push(s));t instanceof fullproof.ScoredElement?this.useScore?r.get(s).insert({v:t.value,s:t.score}):r.get(s).insert(t.value):r.get(s).insert(t)}0<i.length?e(this,i,r,b,d,0):b(!0)};i.prototype.lookup=function(a,b){var d=this.database.transaction([this.name]).objectStore(this.name),g=this;c(d,a,void 0,function(c){if(c&&c.v){for(var d=new fullproof.ResultSet(g.comparatorObject),e=0,f=c.v.length;e<f;++e){var h=c.v[e];g.useScore?d.insert(new fullproof.ScoredEntry(a,h.v,h.s)):d.insert(h)}b(d)}else b(new fullproof.ResultSet(g.comparatorObject))},
function(){b(new fullproof.ResultSet(g.comparatorObject))})};fullproof.store.IndexedDBStore=function(a){this.meta=this.database=null;this.metaStoreName="fullproof_metatable";this.stores={};this.opened=!1;this.dbName="fullproof";this.dbSize=5242880;this.dbVersion=a||"1.0"};fullproof.store.IndexedDBStore.storeName="MemoryStore";fullproof.store.IndexedDBStore.getCapabilities=function(){return(new fullproof.Capabilities).setStoreObjects(!1).setVolatile(!1).setAvailable(null!=fullproof.store.indexedDB).setUseScores([!0,
!1])};fullproof.store.IndexedDBStore.prototype.setOptions=function(a){this.dbSize=a.dbSize||this.dbSize;this.dbName=a.dbName||this.dbName;return this};fullproof.store.IndexedDBStore.prototype.open=function(a,d,g,e){function h(a){for(var c=0;c<a.indexRequests.length;++c){var b=a.indexRequests[c],d=b.capabilities.getComparatorObject()?b.capabilities.getComparatorObject():a.useScore?fullproof.ScoredElement.comparatorObject:void 0,d=new i(a,a.database,b.name,d,b.capabilities.getUseScores());a.stores[b.name]=
d;m.push(d)}}function p(a,d,g,e,f){if(0==g.length)return e(!0);var h=a.transaction([d.metaStoreName],fullproof.store.READWRITEMODE).objectStore(d.metaStoreName),i=g.shift();c(h,i.name,{id:i.name,init:!1},function(c){if(!1==c.init&&i.initializer){var h=d.getIndex(i.name);fullproof.call_new_thread(function(){h.clear(function(){i.initializer(d.getIndex(i.name),function(){fullproof.call_new_thread(p,a,d,g,e,f);fullproof.call_new_thread(function(){var g=a.transaction([d.metaStoreName],fullproof.store.READWRITEMODE).objectStore(d.metaStoreName);
c.init=!0;b(g.put(c),function(){},function(){})})})})})}else fullproof.call_new_thread(p,a,d,g,e,f)},f)}void 0!==a.getDbName()&&(this.dbName=a.getDbName());void 0!==a.getDbSize()&&(this.dbSize=a.getDbSize());var k=this,m=[];this.indexRequests=d;a=fullproof.store.indexedDB.open(this.dbName,this.dbVersion);a.onerror=function(){e()};a.onsuccess=function(a){k.database=a.result||a.target.result;if(k.database.version!==void 0&&k.database.setVersion&&k.database.version!=k.dbVersion){a=k.database.setVersion(k.dbVersion);
a.onerror=fullproof.make_callback(e,"Can't change version with setVersion("+k.dbVersion+")");a.onsuccess=function(){f(k.database,d,k.metaStoreName);var a=k.database,c=k.indexRequests;f(a,c,k.metaStoreName);h(k);fullproof.call_new_thread(p,a,k,[].concat(c),function(){g(m)},e)}}else{var a=k.database,c=k.indexRequests,b=fullproof.make_callback(g,m);f(a,c,k.metaStoreName);h(k);fullproof.call_new_thread(p,a,k,[].concat(c),b,e)}};a.onupgradeneeded=function(a){f(a.target.result,d,k.metaStoreName)}};fullproof.store.IndexedDBStore.prototype.close=
function(a){a()};fullproof.store.IndexedDBStore.prototype.getIndex=function(a){return this.stores[a]}})(window);fullproof=fullproof||{};fullproof.store=fullproof.store||{};
(function(){function a(){this.data={};this.comparatorObject=null;this.useScore=!1}function b(a,b){b&&b(this)}function d(c,b,d,f,e){var h=new a,j=void 0!==d.getUseScores()?d.getUseScores():!1;h.comparatorObject=d.getComparatorObject()?d.getComparatorObject():j?fullproof.ScoredElement.comparatorObject:void 0;h.useScore=j;h.name=b;c.indexes[b]=h;f?f(h,function(){e(h)}):e(h);return h}fullproof.store.MemoryStore=function(){if(!(this instanceof fullproof.store.MemoryStore))return new fullproof.store.MemoryStore(comparatorObject);
this.indexes={};return this};fullproof.store.MemoryStore.getCapabilities=function(){return(new fullproof.Capabilities).setStoreObjects([!0,!1]).setVolatile(!0).setAvailable(!0).setUseScores([!0,!1])};fullproof.store.MemoryStore.storeName="MemoryStore";fullproof.store.MemoryStore.prototype.open=function(a,i,g){var f=this;b(a,function(){for(var a=fullproof.make_synchro_point(function(a){g(a)},i.length),c=0,b=i.length;c<b;++c){var l=i[c];d(f,l.name,l.capabilities,l.initializer,a)}})};fullproof.store.MemoryStore.prototype.getIndex=
function(a){return this.indexes[a]};fullproof.store.MemoryStore.prototype.close=function(a){this.indexes={};a(this)};a.prototype.clear=function(a){this.data={};a&&a(!0);return this};a.prototype.inject=function(a,b,d){this.data[a]||(this.data[a]=new fullproof.ResultSet(this.comparatorObject));!1===this.useScore&&b instanceof fullproof.ScoredElement?this.data[a].insert(b.value):this.data[a].insert(b);d&&d(a,b);return this};a.prototype.injectBulk=function(a,b,d,f){for(var e=0;e<a.length&&e<b.length;++e)0==
e%1E3&&f&&f(e/a.length),this.inject(a[e],b[e]);d&&d(a,b);return this};a.prototype.lookup=function(a,b){b(this.data[a]?this.data[a].clone():new fullproof.ResultSet);return this}})();fullproof=fullproof||{};fullproof.store=fullproof.store||{};
(function(){function a(){this.comparatorObject=this.tableName=this.store=this.db=null;this.opened=this.useScore=!1}function b(a,b,i){this.tablename="fullproofmetadata";var g=this;this.createIndex=function(b,c,h){var i=fullproof.make_callback(h);a.db.transaction(function(h){var q=function(q){q?c(!0):h.executeSql("CREATE TABLE IF NOT EXISTS "+b+" (id NCHAR(48), value, score)",[],function(){a.db.transaction(function(a){a.executeSql("CREATE INDEX IF NOT EXISTS "+b+"_indx ON "+b+" (id)",[],function(){a.executeSql("INSERT OR REPLACE INTO "+
g.tablename+" (id, initialized) VALUES (?,?)",[b,!1],fullproof.make_callback(c,!0),i)},i)})},i)};h.executeSql("SELECT * FROM "+b+" LIMIT 1,0",[],function(a,b){1==b.rows.length?q(!0):q(!1)},fullproof.make_callback(q,!1))})};this.loadMetaData=function(b){a.db.transaction(function(a){a.executeSql("SELECT * FROM "+g,tablename+" WHERE id=?",[tableName],function(a,c){for(var d={},g=0;g<c.rows.length;++g){var e=c.rows.item(g);d[e.id]={name:e.id,initialized:e.initialized,ctime:e.ctime,version:e.version}}b(d)},
fullproof.make_callback(b,{}))})};this.isInitialized=function(b,c){a.db.transaction(function(a){a.executeSql("SELECT * FROM "+g.tablename+" WHERE id=?",[b],function(a,b){if(1==b.rows.length){var d=b.rows.item(0);c("true"==d.initialized)}else c(!1)},fullproof.make_callback(c,!1))})};this.setInitialized=function(b,c,h){a.db.transaction(function(a){a.executeSql("INSERT OR REPLACE INTO "+g.tablename+" (id, initialized) VALUES (?,?)",[b,c?"true":"false"],fullproof.make_callback(h,!0),fullproof.make_callback(h,
!1))})};this.getIndexSize=function(b,c){a.db.transaction(function(a){a.executeSql("SELECT count(*) AS cnt FROM "+b,[],function(a,b){if(1==b.rows.length){var d=b.rows.item(0);if(void 0!==d.cnt)return c(d.cnt)}c(!1)},function(){c(!1)})})};this.eraseMeta=function(){g.loadMetaData(function(b){a.db.transaction(function(a){var c=0,d;for(d in b)++c;fullproof.make_synchro_point(function(){a.executeSql("DROP TABLE IF EXISTS "+g.tablename,[],fullproof.make_callback(i,!0),fullproof.make_callback(i,!1))},c);
for(d in b)a.executeSql("DROP TABLE IF EXISTS "+d)})})};a.db.transaction(function(f){f.executeSql("CREATE TABLE IF NOT EXISTS "+g.tablename+" (id VARCHAR(52) NOT NULL PRIMARY KEY, initialized, version, ctime)",[],function(){b(a)},fullproof.make_callback(i,!1))})}fullproof.store.WebSQLStore=function(){if(!(this instanceof fullproof.store.WebSQLStore))return new fullproof.store.WebSQLStore;this.internal_init=function(){this.meta=this.db=null;this.tables={};this.indexes={};this.opened=!1;this.dbName=
...
function(d,c,i){function g(b){if(0==b.length)return i(e);var c=b.shift();var d=f,h=c.name,j=c.capabilities,k=c.initializer,m=function(a){e.push(a);g(b)};if(!1==d.opened||!d.meta)m(!1);else{var j=j||{},n=new a;n.store=d;c=void 0!==j.getUseScores()?j.getUseScores():!1;n.db=d.db;n.tableName=n.name=h;n.comparatorObject=j.getComparatorObject()?j.getComparatorObject():c?fullproof.ScoredElement.comparatorObject:void 0;n.useScore=c;d.meta.isInitialized(h,function(a){if(a)return m(n);d.meta.createIndex(h,
function(){d.indexes[h]=n;k?fullproof.call_new_thread(function(){n.clear(function(){fullproof.call_new_thread(function(){k(n,function(){n.opened=!0;d.meta.setInitialized(h,!0,fullproof.make_callback(m,n))})})})}):m(n)},void 0)})}}var f=this,e=[];this.dbName=d.getDbName()||this.dbName;var h=function(){fullproof.make_synchro_point(i,c.length);[].concat(c);g([].concat(c))};this.opened=!1;void 0!==d.getDbName()&&(this.dbName=d.getDbName());void 0!==d.getDbSize()&&(this.dbSize=d.getDbSize());try{this.db=
openDatabase(this.dbName,"1.0","javascript search engine",this.dbSize)}catch(j){console&&console.log&&console.log("websql: ERROR in openStore"+j)}this.opened=!0;this.meta=new b(this,function(a){h(a)},fullproof.make_callback(h,!1))};fullproof.store.WebSQLStore.prototype.close=function(a){this.internal_init();a()};fullproof.store.WebSQLStore.prototype.getIndex=function(a){return this.indexes[a]};a.prototype.clear=function(a){var b=this;this.db.transaction(function(i){i.executeSql("DELETE FROM "+b.tableName,
[],function(){b.store.meta.setInitialized(b.name,!1,a)},function(){fullproof.make_callback(a,!1)()})})};a.prototype.inject=function(a,b,i){var g=this;this.db.transaction(function(f){b instanceof fullproof.ScoredElement?f.executeSql("INSERT OR REPLACE INTO "+g.tableName+" (id,value, score) VALUES (?,?,?)",[a,b.value,b.score],fullproof.make_callback(i,!0),fullproof.make_callback(i,!1)):f.executeSql("INSERT OR REPLACE INTO "+g.tableName+" (id,value) VALUES (?,?)",[a,b],fullproof.make_callback(i,!0),
fullproof.make_callback(i,!1))})};a.prototype.injectBulk=function(a,b,i,g){var f=this;if(a.length!=b.length)throw"Can't injectBulk, arrays length mismatch";var e=fullproof.make_synchro_point(i,void 0,!0),h=a.length,j=function(a,b){var c=a.splice(0,100<a.length?100:a.length),d=b.splice(0,100<b.length?100:b.length);0==c.length&&e(!1);g&&g((h-a.length)/h);var i=fullproof.make_synchro_point(function(){fullproof.call_new_thread(j,a,b)},c.length);f.db.transaction(function(a){for(var b=0;b<c.length;++b){var g=
d[b];g instanceof fullproof.ScoredEntry?f.useScore?a.executeSql("INSERT INTO "+f.tableName+" (id,value, score) VALUES (?,?,?)",[c[b],g.value,g.score],i,function(){}):a.executeSql("INSERT INTO "+f.tableName+" (id,value) VALUES (?,?)",[c[b],g.value],i,i):f.useScore?a.executeSql("INSERT INTO "+f.tableName+" (id,value, score) VALUES (?,?,?)",[c[b],g,1],i,i):a.executeSql("INSERT INTO "+f.tableName+" (id,value) VALUES (?,?)",[c[b],g],function(){i()},function(){i(!0)})}})};j(a,b)};a.prototype.lookup=function(a,
b){var i=this;this.db.transaction(function(g){g.executeSql("SELECT * FROM "+i.tableName+" WHERE id=? ORDER BY value ASC",[a],function(a,d){for(var g=[],j=0;j<d.rows.length;++j){var l=d.rows.item(j);l&&(null===l.score||void 0===l.score||!1===l.score?g.push(l.value):g.push(new fullproof.ScoredEntry(l.id,l.value,l.score)))}b((new fullproof.ResultSet(i.comparatorObject)).setDataUnsafe(g))},function(){b(!1)})})}})();fullproof=fullproof||{};
...
[],d=[];this.setQueue=function(){for(var a=0;a<arguments.length;++a)arguments[a].constructor==Array?b=b.concat(arguments[a]):b.push(arguments[a]);return this};var c=function(b,g,f){if(0==d.length)b();else{var e=d.shift(),h=a();h.onreadystatechange=function(){if(4==h.readyState)if(200!=h.status)f&&(f(e),c(b,g,f));else{var a=h.responseText;g&&(g(a,e),c(b,g,f))}};h.open("GET",e,!0);h.send(null)}};this.start=function(a,g,f){d=[].concat(b);c(a,g,f)}}})();var net=net||{};net.kornr=net.kornr||{};
...
(function(a){function b(a,b){if(void 0===a)return function(){throw"Missing data, you need to include "+b;};var c,d=0;c=function(b){for(var c=d,e=a[c],e=1,f=0;0<=c&&c<a.length;){e=a[c];if(e instanceof Array)if(b<e[0])e=-1;else if(b>e[1])e=1;else return d=c,!0;else{if(e==b)return d=c,!0;e=b<e?-1:1}if(0==f)f=e;else if(f!=e)break;c+=e;if(c>a.length||0>c)break}return!1};return function(a){switch(typeof a){case "number":return c(a);case "string":for(var b=0,d=a.length;b<d;++b)if(!1===c(a.charCodeAt(b)))return!1;
return!0}return!1}}function d(a,b){function d(b,e){if(0>e)return i;if(e>=a.length)return c;var f=a[e];if(!f)return!1;if(2==f.length){if(f[0]==b)return f[1]}else if(f[0]<=b&&f[1]>=b)return"R"==f[2]?b+f[3]:f[3];return f[0]>b?c:i}if(void 0===a)return function(){throw"Missing data, you need to include "+b;};var h=0;return function(a){for(var b="",c=0,g=a.length;c<g;++c){var f;a:{f=a.charCodeAt(c);var p=h,k=d(f,p);if(0>k){for(var m=k,n=m==i?1:-1;k===m;)if(p+=n,k=d(f,p),!(0>k)){h=p;f=k;break a}h=p}else f=
k}if(f instanceof Array)for(p=0;p<f.length;++p)b+=String.fromCharCode(f[p]);else b+=String.fromCharCode(f)}return b}}var c=-1,i=-2;a.lowercase_nomark=d(a.norm_lowercase_nomark_data,"normalizer_lowercase_nomark.js");a.lowercase=d(a.norm_lowercase_data,"normalizer_lowercase.js");a.uppercase_nomark=d(a.norm_uppercase_nomark_data,"normalizer_uppercase_nomark.js");a.uppercase=d(a.norm_uppercase_data,"normalizer_uppercase.js");a.is_letter=b(a.categ_letters_data,"categ_letters.js");a.is_letter_number=b(a.categ_letters_numbers_data,
"categ_letters_numbers.js");a.is_number=b(a.categ_numbers_data,"categ_numbers.js");a.is_punct=b(a.categ_punct_data,"categ_puncts.js");a.is_separator=b(a.categ_separators_data,"categ_separators.js");a.is_punct_separator=b(a.categ_puncts_separators_data,"categ_puncts_separators_controls.js");a.is_punct_separator_control=b(a.categ_puncts_separators_controls_data,"categ_puncts_separators.js");a.is_control=b(a.categ_controls_data,"categ_controls.js");a.is_math=b(a.categ_maths_data,"categ_maths.js");a.is_currency=
b(a.categ_currencies_data,"categ_currencies.js");return a})(net.kornr.unicode);
fullproof=function(a){a.english=a.english||{};a.english.metaphone=function(a,d){var d=d||32,a=a.toLowerCase(),a=a.replace(/([^c])\1/g,"$1"),a=a.match(/^(kn|gn|pn|ae|wr)/)?a.substr(1,a.length-1):a,a=a.replace(/mb$/,"m"),a=a.replace(/ck/g,"k"),c;c=a.replace(/([^s]|^)(c)(h)/g,"$1x$3").trim();c=c.replace(/cia/g,"xia");c=c.replace(/c(i|e|y)/g,"s$1");c=c.replace(/c/g,"k");c=c.replace(/d(ge|gy|gi)/g,"j$1");c=c.replace(/d/g,"t");c=c.replace(/gh(^$|[^aeiou])/g,"h$1");c=c.replace(/g(n|ned)$/g,"$1");c=c.replace(/([^g]|^)(g)(i|e|y)/g,
"$1j$3");c=c.replace(/gg/g,"g");c=c.replace(/g/g,"k");a=c.replace(/([aeiou])h([^aeiou])/g,"$1$2");a=a.replace(/ph/g,"f");a=a.replace(/q/g,"k");a=a.replace(/s(h|io|ia)/g,"x$1");c=a.replace(/^x/,"s");c=c.replace(/x/g,"ks");c=c.replace(/t(ia|io)/g,"x$1");c=c.replace(/th/,"0");a=c.replace(/tch/g,"ch");a=a.replace(/v/g,"f");a=a.replace(/^wh/,"w");a=a.replace(/w([^aeiou]|$)/g,"$1");a=a.replace(/y([^aeiou]|$)/g,"$1");a=a.replace(/z/,"s");a=a.charAt(0)+a.substr(1,a.length).replace(/[aeiou]/g,"");a.toUpperCase();
a.length>=d&&(a=a.substring(0,d));return a.toUpperCase()};return a}(fullproof||{});
fullproof=function(a){a.english=a.english||{};var b=a.english,d=[];d.ational="ate";d.tional="tion";d.enci="ence";d.anci="ance";d.izer="ize";d.bli="ble";d.alli="al";d.entli="ent";d.eli="e";d.ousli="ous";d.ization="ize";d.ation="ate";d.ator="ate";d.alism="al";d.iveness="ive";d.fulness="ful";d.ousness="ous";d.aliti="al";d.iviti="ive";d.biliti="ble";d.logi="log";var c=[];c.icate="ic";c.ative="";c.alize="al";c.iciti="ic";c.ical="ic";c.ful="";c.ness="";b.porter_stemmer=function(a){var b,f,e=a;if(3>a.length)return a;
var h,j,a=a.substr(0,1);"y"==a&&(e=a.toUpperCase()+e.substr(1));h=/^(.+?)(ss|i)es$/;f=/^(.+?)([^s])s$/;h.test(e)?e=e.replace(h,"$1$2"):f.test(e)&&(e=e.replace(f,"$1$2"));h=/^(.+?)eed$/;f=/^(.+?)(ed|ing)$/;h.test(e)?(f=h.exec(e),h=/^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*/,h.test(f[1])&&(h=/.$/,e=e.replace(h,""))):f.test(e)&&(f=f.exec(e),b=f[1],f=/^([^aeiou][^aeiouy]*)?[aeiouy]/,f.test(b)&&(e=b,f=/(at|bl|iz)$/,j=/([^aeiouylsz])\1$/,b=/^[^aeiou][^aeiouy]*[aeiouy][^aeiouwxy]$/,f.test(e)?
e+="e":j.test(e)?(h=/.$/,e=e.replace(h,"")):b.test(e)&&(e+="e")));h=/^(.+?)y$/;h.test(e)&&(f=h.exec(e),b=f[1],h=/^([^aeiou][^aeiouy]*)?[aeiouy]/,h.test(b)&&(e=b+"i"));h=/^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/;h.test(e)&&(f=h.exec(e),b=f[1],f=f[2],h=/^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*/,h.test(b)&&(e=b+d[f]));h=/^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/;h.test(e)&&(f=h.exec(e),
b=f[1],f=f[2],h=/^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*/,h.test(b)&&(e=b+c[f]));h=/^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/;f=/^(.+?)(s|t)(ion)$/;h.test(e)?(f=h.exec(e),b=f[1],h=/^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*[aeiouy][aeiou]*[^aeiou][^aeiouy]*/,h.test(b)&&(e=b)):f.test(e)&&(f=f.exec(e),b=f[1]+f[2],f=/^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*[aeiouy][aeiou]*[^aeiou][^aeiouy]*/,f.test(b)&&(e=b));h=
/^(.+?)e$/;if(h.test(e)&&(f=h.exec(e),b=f[1],h=/^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*[aeiouy][aeiou]*[^aeiou][^aeiouy]*/,f=/^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*([aeiouy][aeiou]*)?$/,j=/^[^aeiou][^aeiouy]*[aeiouy][^aeiouwxy]$/,h.test(b)||f.test(b)&&!j.test(b)))e=b;h=/ll$/;f=/^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*[aeiouy][aeiou]*[^aeiou][^aeiouy]*/;h.test(e)&&f.test(e)&&(h=/.$/,e=e.replace(h,""));"y"==a&&(e=a.toLowerCase()+e.substr(1));return e};
return a}(fullproof||{});
